...
public class FlumeTopologyPropertiesGeneratorTreeTest {
    ...
    public void test02LoadJSONTopologyFile() {
        ...
        try {
            ...
            FlumeTopologyPropertiesGenerator.setPathJSONTopology(TREE_TOPOLOGY_FILE_PATH);
    ...
    public void test03CreateInitialStructures() {
        ...
        try {
            ...
            Map<String, DefaultMutableTreeNode> flumeTreeTopology = flumeTopologyPropertiesGenerator.getFlumeTreeTopology();
            Assert.assertTrue("The creation of the initial structures is not correct", flumeTreeTopology.isEmpty());
            ...
            flumeTreeTopology = flumeTopologyPropertiesGenerator.getFlumeTreeTopology();
            Assert.assertNotNull("The creation of the initial structures is not correct", flumeTreeTopology);
            Assert.assertTrue("The creation of the initial structures is not correct", flumeTreeTopology.size() > 0);
    ...
    public void test12GenerateInputProperties() {
        ...
        try {
            ...
            //Compute tree as graph
            FlumeTopologyPropertiesGenerator.setComputeTreeAsGraph(true);
    ...
    @Test
    public void test13GenerateInputPropertiesFromJSONTopology() {
        ...
        try {
            ...
            encodedFile = Files.readAllBytes(Paths.get(TREE_TOPOLOGY_FILE_PATH));
            ...
            Assert.fail("An error has occurred [test13GenerateInputPropertiesFromJSONTopology] method");
            logger.error("An error has occurred [test13GenerateInputPropertiesFromJSONTopology] method", e);
        }
    }
